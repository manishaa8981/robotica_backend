...
const getImpacts = async (req, res) => {
    try {
        const section = await Impacts.findOne();
...
const addItem = async (req, res) => {
    try {
        ...
        const section = await Impacts.findById(mainId);
